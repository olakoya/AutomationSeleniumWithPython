# Checkout Day 19 Class_Object_Notes for Inheritance Notes
'''
...
------------------------------------
1. By using classname or object reference variable one can access memebers of one class inside another class
