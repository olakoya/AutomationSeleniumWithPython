...
class Test: # class creation
    ...
    def test(self): # function created in a class is called mathod i.e creating a method
...
print(t1.a) # to see a data present in "a = 10", print will help in the access of variable "a" with the object "t1"
t1.test() # we are access an object "t1.test()" with the help of "print(t1.a)" and print out the value in a = 10
print(t2.a)
t2.test() 
...
'''
Method is a function created inside a class and class is a blueprint
...
Once it's created we to specify this "def test(self):" one would get an error
And when a class variable "a = 10" is created one can access it through "print(self.a)"
To make our class physically appeared we need to create an object "Test" with open close parenthensis
For instance in building a house we need to design it before construction
Therefore designing of the house is class method while construction is the test() object
For single class we can create any total number of object
...
We are access an object "t1.test()" with the help of "print(t1.a)" and print out the value in a = 10
