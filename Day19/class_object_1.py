...
class Test: # class creation
    ...
    def test(self): # function created in a class is called method i.e creating a method and testingfile name is testingfile
...
t1.test() # we are accessing an object "t1.testingfile()" with the help of "print(t1.a)" and print out the value in a = 10
print(t2.a)
t2.test() 
...
--------------------------------
Inside "class Test:" this "def testingfile(self):" is defined i.e. 
To say "def testingfile(self):" is a property of this "class Test:" we need to use the "self" parameter
And "self" is a mandatory parameters
Once it's created we need to specify this "def testingfile(self):" otherwise one would get an error
...
Therefore designing of the house in this instance is class method while construction is the testingfile() object
...
We are accessing an object "t1.testingfile()" with the help of "print(t1.a)" and print out the value in a = 10
With the help of "t1.testingfile()" we are calling the method "print(self.a)"
'''