...
There are lots of datat types in python.
Data Type represents the type of data present inside a variable.
In python we are not required to specify the type explicity . 
...
In python everything is an object including dot (.), (,) etc. anyhting is treated as an object in python
