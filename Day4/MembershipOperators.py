...
# ---------------------
# This means it will check presence of an element/object/item inside a sequences (string, list, tuple, set, dictionary) like multple sequences
...
print("W" in a) # Output is a True Boolean Value because capital letter "w" is part of the "Welcome" sequence
print("W" not in a) # Output is a False Boolean Value because small letter "w" is part of the "Welcome" sequence
