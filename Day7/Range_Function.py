...
# Python file is a range of module and inside this module we can create class, functions etc
'''
...
# range is like a key word that only generate a sequence of numbers and not for any other purpose
# range will generate a sequence of numbers from 0
# converting it to list of datatype by adding "print(list())"
'''
...
Output is 
range(0, 20)
This range gives a ra nge of numbers
'''
...
The sequence started from 0 and ends in 199
'''
# From instance we want to start the range from 75, this is where we use Form 2 range (start, stop)
#  
'''
Output is 
...
'''
# To generate only odd numbers starting from 1 to 100

# range(1,101,2)
# 1, 3, 5, 7, 9 ==> odd numbers
# # lets add list data structure
...
# Step ==> negative ==> reverse direction ==> R to L ==> stop or end + 
# 0, 2, 4, 6, 8, 10 ==> even numbers
# 1, 3, 5, 7, 9 ==> odd numbers
